...
admin = User(email="zouhair@admin.ma", username="aicha", password=bcrypt.generate_password_hash("password123"), country="morocco", address="casablanca", phone="12345678")
```
Make the user admin
```
admin.is_admin = True
...
# Authors
* Zouhair Ouled Bouia [Github](https://github.com/ZooHairDev) / [Linkedin](https://www.linkedin.com/in/zouhairouled/)
